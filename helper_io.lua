...
function g_sta_mac()
	return wifi.sta.getmac() or "01:23:45:67:89:A"
end 

function g_ap_mac()
	return wifi.ap.getmac() or "11:22:33:44:55:66"
end

function g_heap()
	return node.heap() or "11:22:33:44:55:66"
end

function g_chipid()
	return node.chipid() or "11:22:33:44:55:66"
end

function g_flashsize()
	return node.flashsize() or "77776"
end

function g_flashid()
	return node.flashid() or "9999"
end
...
function g_wifi_ap() 
	local ip, mask, gateway = wifi.ap.getip()
	return ip, mask, gateway
end

function tmr_rst(z,time)
tmr.alarm(TMR[z].n, time or TMR[z].t, 1, TMR[z].f)
end
